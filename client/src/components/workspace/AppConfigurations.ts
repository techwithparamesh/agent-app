  ...
  actions: [
    {
      ...
      fields: [
        ...
        { key: 'from', label: 'From Number (optional)', type: 'text', placeholder: '+1234567890', helpText: 'Overrides the credential From Number if provided' },
  ...
  actions: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'lastName', label: 'Last Name', type: 'text' },
        { key: 'phone', label: 'Phone', type: 'text' },
        { key: 'acceptsMarketing', label: 'Accepts Marketing', type: 'boolean', default: false },
        { key: 'tags', label: 'Tags', type: 'text' },
        { key: 'note', label: 'Note', type: 'textarea' },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          dependsOn: { field: 'lookupBy', value: 'username' },
        },
        {
          key: 'userId',
          label: 'User ID',
          type: 'text',
          required: true,
          dependsOn: { field: 'lookupBy', value: 'userId' },
        },
      ],
    },
  ],
