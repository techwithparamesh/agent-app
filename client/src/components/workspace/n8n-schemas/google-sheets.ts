      ...
      operations: [
        {
          ...
          fields: [
            ...
            {
              id: 'values',
              displayName: 'Row Values (JSON)',
              name: 'values',
              type: 'json',
              required: true,
              description: 'Row data as JSON array of values: ["value1", "value2", ...]',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'string',
              required: true,
              description: 'A1 notation range to update (e.g., A2:D2)',
              placeholder: 'A2:D2',
            },
            {
              id: 'values',
              ...
              type: 'json',
              required: true,
              description: 'Values as 2D JSON array: [["value1", "value2"]]',
